...
This code is written for the adafruit breakout of the Bosch BNO055 chip.
We will rewrite it here for the sparkfun breakout of the TDK Invensense ICM20948 chip.

myIMU  adafruit BNO055
...
Adafruit_BNO05 myIMU = Adafruit_BNO055();
